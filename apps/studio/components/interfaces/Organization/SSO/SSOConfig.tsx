      ...
      <ScaffoldSection isFullWidth>
        {isLoadingEntitlement || (hasAccessToSso && isLoadingSSOConfig) ? (
          ...
          <UpgradeToPro
            ...
            secondaryText="SSO as a login option provides additional account security for your team by enforcing the use of an identity provider when logging in."
                          ...
                          >
                            <div className="space-y-3 text-sm">
                              ...
                              <div>
                                ...
                                directly authenticated into the dashboard. Works automatically without
