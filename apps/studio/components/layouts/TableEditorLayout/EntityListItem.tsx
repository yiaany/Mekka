...
import { StudioDomainEntityListItem } from './StudioDomainEntityListItem'
...
export const EntityListItem = (props: EntityListItemProps) => {
  if (props.item.source === 'studio-domain') {
    return <StudioDomainEntityListItem item={props.item} style={props.style} />
  }

  return <PostgresEntityListItem {...props} />
}

const PostgresEntityListItem = ({
  id,
  projectRef,
  item: entity,
  isLocked,
