import type { UIMessage as MessageType, UseChatOptions } from '@ai-sdk/react'
...
export const AIAssistant = ({ className }: AIAssistantProps) => {
  ...
  const activeChat = snap.activeChatId ? state.chatInstances[snap.activeChatId] : undefined
  const chatOptions: UseChatOptions<MessageType> = activeChat
    ? { chat: activeChat }
    : {
  ...
  const {
    ...
    stop,
    regenerate,
  } = useChat<MessageType>(chatOptions)
