import { createStudioAuthAdminClient } from '@mekka/studio-domain-sdk'
...
export function createProjectStudioAuthClient(projectRef: string) {
  ...
  return createStudioAuthAdminClient({
    baseUrl: `/api/platform/auth-admin/${encodeURIComponent(projectRef)}`,
    tenant,
    getCredential: async () => {
