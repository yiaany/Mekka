...
function CustomApp({ Component, pageProps }: AppPropsWithLayout) {
  ...
  const isNonProdEnv = IS_PLATFORM && process.env.NEXT_PUBLIC_ENVIRONMENT !== 'prod'
                ...
                <ProfileProvider>
                  <TimezoneProvider>
                    <TimestampInfoTimezoneBridge>
                      <Head>
                        <title>{appTitle ?? STUDIO_BRAND.name}</title>
                        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
                        <meta property="og:image" content={`${BASE_PATH}/img/mekka-logo.svg`} />
                      ...
                      <MetaFaviconsPagesRouter
                        includeManifest
                        applicationName={STUDIO_BRAND.description}
